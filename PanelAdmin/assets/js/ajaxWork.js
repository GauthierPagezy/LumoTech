...
function showHistoriqueAuto(){  
    $.ajax({
        url:"./adminView/viewHistoriqueAuto.php",
        method:"post",
        data:{record:1},
...
function showHistoriqueManuel(){  
    $.ajax({
        url:"./adminView/viewHistoriqueManuel.php",
        method:"post",
        data:{record:1},
        success:function(data){
            $('.allContent-section').html(data);
...
function showLampadaires(){  
    $.ajax({
        url:"./adminView/viewLampadaires.php",
        method:"post",
        data:{record:1},
        success:function(data){
            $('.allContent-section').html(data);
